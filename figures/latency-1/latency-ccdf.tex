...
\addplot [mark=none,color=TUMOrange, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {csharp-cdf.csv};
\addplot [mark=none,color=TUMYellow, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {ocaml-cdf.csv};
\addplot [mark=none,color=TUMPurple, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {swift-cdf.csv};
\addplot [mark=none,color=TUMRed, thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {haskell-cdf.csv};
