...
%	label style={font=\fontsize{8}{9}\selectfont},
	...
	legend entries={C, Rust, Go, C\#, OCaml},
	legend pos = north east
]
\addplot [mark=none,color=TUMBlack, thick] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {c-cdf.csv};
\addplot [mark=x,color=TUMDarkerBlue, thick,mark repeat*=15] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {rust-cdf.csv};
\addplot [mark=triangle*,color=TUMGreen, thick,mark repeat*=18] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {go-cdf.csv};
\addplot [mark=+,color=TUMOrange, thick,mark repeat*=35] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {csharp-cdf.csv};
