...
\addplot [mark=none,color=TUMDarkerBlue,ultra thick] table[col sep=comma,y=lat,x expr=1-\thisrow{cdf}] {latency-rust.csv};
\addplot [mark=none,color=TUMDarkYellow,ultra thick] table[col sep=comma,y=lat, x expr=1-\thisrow{cdf}] {latency-go.csv};
\addplot [mark=none,color=TUMOrange,ultra thick] table[col sep=comma,y=lat, x expr=1-\thisrow{cdf}] {latency-cs.csv};
\end{axis}
\end{tikzpicture}
\end{document}
